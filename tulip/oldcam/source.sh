...
export KERNEL_BRANCH=deagle
export DEVICE_CODENAME=tulip
export DEVICE_DEFCONFIG=deagle_tulip_defconfig
...
bash rm.sh
tg_post_msg "<b>NFSKernel-Redmi Note 6 Pro (tulip):</b><code>Started build witch NFS Clang</code>"
echo "started build witch NFS Clang"
bash NFS.sh
echo "membersihkan config sebelumnya"
bash rm.sh
tg_post_msg "<b>NFSKernel-Redmi Note 6 Pro (tulip):</b><code>Started build witch Proton Clang</code>"
echo "started build witch Proton Clang"
bash Proton.sh
tg_post_msg "<b>NFSKernel-Redmi Note 6 Pro (tulip):</b><code>Aku capek sayank, semuanya sudah selesai. Aku istirahat dulu ya..  Bay bay 😘😘</code>"
