...
bash rm.sh
tg_post_msg "<b>NFSKernel-overclock-(rosy):</b><code>Started build witch NFS Clang</code>"
...
bash Proton.sh
tg_post_msg "<b>NFSKernel-overclock-(rosy):</b><code>Aku capek sayank, semuanya sudah selesai. Aku istirahat dulu ya..  Bay bay 😘😘</code>"
